...
public class ManageSuppliers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnRemove.setMaximumSize(new java.awt.Dimension(128, 29));
        btnRemove.setMinimumSize(new java.awt.Dimension(128, 29));
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Supplier s = (Supplier)supplierTable.getValueAt(row,0); //0 means column 0
