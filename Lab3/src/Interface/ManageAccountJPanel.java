...
public class ManageAccountJPanel extends javax.swing.JPanel {
    ...
    private void populateTable(){
        ...
        for(Account account: accountDirectory.getAccountList()){
           Object[] row = new Object[4]; //new row with 4 columns 
           row[0] = account;
    ...
    private void initComponents() {
        ...
        btnSearch.setMaximumSize(new java.awt.Dimension(85, 30));
        btnSearch.setMinimumSize(new java.awt.Dimension(85, 30));
        ...
        btnViewDetails.setMaximumSize(new java.awt.Dimension(85, 30));
        btnViewDetails.setMinimumSize(new java.awt.Dimension(85, 30));
        ...
        btnDeleteAccount.setMaximumSize(new java.awt.Dimension(85, 30));
        btnDeleteAccount.setMinimumSize(new java.awt.Dimension(85, 30));
    ...
    private void btnDeleteAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteAccountActionPerformed
        ...
        if (selectedRow >= 0){
            ...
            if (dialogResult == JOptionPane.YES_OPTION){
                Account account = (Account) tblAccounts.getValueAt(selectedRow, 0); //(Account) means Account of tblAccounts, 0 means column0 account
                accountDirectory.deleteAccount(account);
                populateTable();
            }
        }
        else{
            //JOptionPane.showMessageDialog(Component parentComponent, Object message, String title, int MseeageType, Icon icon);
