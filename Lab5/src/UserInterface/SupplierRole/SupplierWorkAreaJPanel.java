...
public class SupplierWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        managePButton.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        managePButton.setText("Manage Product Catalog >>");
        managePButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        managePButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                managePButtonActionPerformed(evt);
            }
        });
        add(managePButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 330, -1));
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 330, -1));

        jButton3.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jButton3.setText("Manage Staff");
        jButton3.setEnabled(false);
        jButton3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 330, -1));

        reportButton4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        reportButton4.setText("Review Product Performance >>");
        reportButton4.setEnabled(false);
        reportButton4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        reportButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reportButton4ActionPerformed(evt);
            }
        });
        add(reportButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 330, -1));
