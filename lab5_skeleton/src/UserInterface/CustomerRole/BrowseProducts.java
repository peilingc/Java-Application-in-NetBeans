...
public class BrowseProducts extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        productTable.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        ...
        add(suppComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 250, -1));

        jLabel1.setText("Supplier");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 110, 30));
        ...
        add(viewProdjButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 150, -1));
        ...
        add(addtoCartButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 320, 110, -1));

        quantitySpinner.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
        add(quantitySpinner, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, 40, -1));

        jLabel5.setText("Quantity:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 320, -1, -1));
        ...
        add(btnSearchProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 130, -1, -1));

        jLabel6.setText("Sales Price:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 320, -1, -1));
        add(txtSalesPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 320, 60, -1));

        jLabel7.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        jLabel7.setText("Item In Cart");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, -1, -1));

        orderTable.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        ...
        add(btnModifyQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 550, 130, -1));
        ...
        add(btnRemoveOrderItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 550, -1, -1));
        ...
        add(btnCheckOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 550, -1, -1));
        add(txtSearchKeyWord, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 130, 110, -1));
        add(txtNewQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 550, 70, -1));
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        if (fetchQty <= 0){
            JOptionPane.showMessageDialog(null, "Quantity cannot be less than equal to 0!!", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        try{ 
            ...
            if (fetchQty <= selectedProduct.getAvail()){
                ...
                JOptionPane.showMessageDialog(null, "The quantity is greater than the availability!!", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        }
        catch(Exception e){
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
       ...
       if (order.getOrderItemList().size()>0){
           ...
           order = new Order(); //let the orderTable get empty
           refreshOrderTable();
           populateTable();
           isCheckedOut = true;
       }
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if (txtNewQuantity.getText().length()<=0){
            JOptionPane.showMessageDialog(null, "Please enter an number in the field!!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        int oldQty = oi.getQuantity();
        int newAvail = oldAvail + oldQty;
        oi.getProduct().setAvail(newAvail);
        order.removeOrderItem(oi);
        JOptionPane.showMessageDialog(null, "Order item has been removed from the cart!!");
        refreshOrderTable();
        populateTable();
