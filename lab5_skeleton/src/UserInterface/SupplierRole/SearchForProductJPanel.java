...
public class SearchForProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 30, -1, 52));
        ...
        add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(316, 144, 130, -1));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 90, -1));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        //if can not transfer from string to int
        catch(Exception e){
            JOptionPane.showMessageDialog(null, "Nothing found", "No result found matching your criteria!!", JOptionPane.WARNING_MESSAGE);
        }
